...
export const Settings: React.FC = () => {
  ...
  const fetchStats = useCallback(async () => {
    ...
    try {
      ...
      setStats({
        ...
        data_size:
          Math.round(
            ((((postsResult.count || 0) * 2 +
              (personaResult.count || 0) * 5 +
              (strategyResult.count || 0) * 3 +
              (simulationResult.count || 0) * 4) *
              1024) /
              1024) *
              100
          ) / 100,
  ...
  const downloadData = async () => {
    try {
      const [posts, persona, strategies, simulations, transparency] =
        await Promise.all([
      ...
      a.href = url;
      a.download = `microme-data-export-${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Email changes require account re-verification
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-gray-600">
                Enable AI analysis of personality traits based on your content
                patterns. This provides insights into openness,
                conscientiousness, extraversion, agreeableness, and neuroticism.
              </div>
              <div className="text-xs text-gray-500 mt-1">
                When disabled: Strategy recommendations focus on content
                patterns without personality insights
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-gray-600">
                Allow content recommendations to include external links and
                resource references.
              </div>
              <div className="text-xs text-gray-500 mt-1">
                When disabled: Content suggestions focus on original content
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <div className="font-medium text-gray-900">
                People & Brand Tagging Suggestions
              </div>
              <div className="text-sm text-gray-600">
                Include suggestions for tagging relevant people, brands, or
                organizations in your content.
              </div>
              <div className="text-xs text-gray-500 mt-1">
                When disabled: Strategy excludes collaboration and networking
                recommendations
              </div>
            </div>
          </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="text-sm text-gray-600 space-y-1">
            ...
            <p>
              • Data is automatically deleted 30 days after account deletion
            </p>
            <p>
              • You can request immediate deletion using the "Delete All Data"
              button above
            </p>
